...
public class BehaviourFactory {
	public DrawBehaviour createDrawBehaviour(final GameObject object) {
	...
	public MoveBehaviour createMoveBehaviour(final BasicEnemy basicEnemy) {
	...
	public CollidableBehaviour createCollidableBehaviour(final BasicEnemy basicEnemy) {
